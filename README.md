...
* **Konsultasi Gizi Interaktif:** Chatbot cerdas berbasis **Google Gemini 2.0 Flash** yang merespons pertanyaan gizi secara *real-time*.
...
<div align="center">
      <video src="videos/2025-06-23 21-37-49.mp4" controls width="700"></video>
</div>
...
Masukan dan kontribusi dari para ahli gizi, dokter, pengembang, dan masyarakat sangat kami harapkan untuk terus menyempurnakan Sago. Jika Anda memiliki saran, temuan *bug*, atau ingin berkontribusi dalam pengembangan, silakan hubungi kami atau buka *issue* di repositori ini.
...
## **Key Features**
  ...
  * **Interactive Nutrition Consultation:** An intelligent chatbot powered by **Google Gemini 2.0 Flash** that responds to nutritional inquiries in *real-time*.
